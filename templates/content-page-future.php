...
<div class="well well-science">
	<div id="carousel-future-science" class="carousel slide" data-ride="carousel" data-interval="10000">
		...
		<div class="carousel-inner" role="listbox">
			<div class="item active">
				<img src="/wp-content/uploads/2017/05/big-data-growth.png" alt="Big Data Growth">
				<div class="carousel-caption">2001: SDSS releases 100 Gigabytes in its first Early Data Release.<br>
					2012: SDSS releases 10 Terabytes in Data Release 12.<br>
					2021: LSST is projected to release 1.5 Petabytes per year.</div>
			</div>
			<div class="item">
				<img src="/wp-content/uploads/2017/05/sdss-logo-with-lines.png" alt="SDSS">
				<div class="carousel-caption">The Sloan Digital Sky Survey  (SDSS) has created the most detailed 
					three-dimensional maps of the Universe ever made, with deep multi-color images of one third of the sky, and 
					spectra for more than three million astronomical objects. </div>
			</div>
			<div class="item">
				<img src="/wp-content/uploads/2017/05/sciserver_logo.png" alt="SciServer">
				<div class="carousel-caption">SciServer is an ambitious cyberinfrastructure project funded by the NSF to enable 
				universal access to and analysis of large scientific datasets.</div>
			</div>
			<div class="item">
				<img src="/wp-content/uploads/2017/05/lsst.png" alt="LSST">
				<div class="carousel-caption">IDIES researchers are working with the Large Synoptic Survey Telescope (LSST) to 
				optimize database storage and access so that researchers around the world can access its expected 15 Petabytes of catalog data.</div>
			</div>
...
<div class="well well-levels">
	<div id="carousel-future-levels" class="carousel slide" data-ride="carousel" data-interval="10000">
		<h2  id="levels">CONTRIBUTE</h2>
		<ol class="carousel-indicators">
			<li data-target="#carousel-future-levels" data-slide-to="0" class="active"></li>
			<li data-target="#carousel-future-levels" data-slide-to="1"></li>
			<li data-target="#carousel-future-levels" data-slide-to="2"></li>
			<li data-target="#carousel-future-levels" data-slide-to="3"></li>
		</ol>
		<div class="carousel-inner" role="listbox">
			<div class="item active">
				<img src="/wp-content/uploads/2017/05/ScienceDomains.png" alt="Mastering Big Data">
				<div class="carousel-caption">Mastering scientific big data is about recruiting and training the world’s best scientific revolutionaries and giving them the resources they need to do the job.</div>
			</div>
			<div class="item">
				<img src="/wp-content/uploads/2017/05/server_corridor.png" alt="Equipment Fund">
				<div class="carousel-caption">$25K: Named seed fund for innovative research.<br>
$50K: Named research fund for novel data analysis hardware.</div>
			</div>
			<div class="item">
				<img src="/wp-content/uploads/2017/05/matthias.png" alt="Graduate Support">
				<div class="carousel-caption">$10K: Named graduate student research stipend.<br>
$50K: Named support for a graduate student for one year.
</div>
			</div>
			<div class="item">
				<img src="/wp-content/uploads/2017/05/renske.png" alt="Post-Doc Support">
				<div class="carousel-caption"> $50K: Named research award for a post-doc for six months. <br>
$100K: Named research award for a post-doc for one year.<br>
$200K: Named research award for a post-doc for two years.</div>
			</div>
			<a class="left carousel-control" href="#carousel-future-levels" role="button" data-slide="prev">
				<span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
				<span class="sr-only">Previous</span>
			</a>
			<a class="right carousel-control" href="#carousel-future-levels" role="button" data-slide="next">
				<span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span>
				<span class="sr-only">Next</span>
			</a>  
		</div>
